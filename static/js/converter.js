...
// 1_ 1 - Obsługa sekcji kafelków/przełączanie formularzy
document.addEventListener('DOMContentLoaded', function() {
  ...
  // 1_ 2 - Obsługa formularza obrazów: strefa drag&drop
  ...
  // 1_ 3 - Obsługa przycisku konwersji obrazu
  ...
  // 2_ 1 - Obsługa przycisku konwersji linków (pobieranie)
  ...
  // 3_ 1 - Inicjalizacja pól i przycisków do szyfrowania
  ...
  // 3_ 2 - Obsługa wczytywania kodu z pliku
  ...
  // 3_ 3 - Obsługa przycisku szyfrowania/deszyfrowania
  ...
  // Drobne funkcje wspólne (pokazywanie/ukrywanie overlayów i wyników)
